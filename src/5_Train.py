...
class AutismDetectionTrainer:
    ...
    def create_model(self, input_shape):
        ...
        # 👇 LSTM'leri çift yönlü hale getiriyoruz
    ...
    def get_callbacks(self):
        ...
        return [
            ...
            ModelCheckpoint(f'best_model_{timestamp}.keras', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
        ]
    ...
    def train_model(self):
        ...
        input_shape = (self.X_train.shape[1], self.X_train.shape[2])  # artık T, d+n_categories
